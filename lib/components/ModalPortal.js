...
var CLASS_NAMES = constants.CLASS_NAMES;
var OVERLAY_STYLES = constants.OVERLAY_STYLES;
...
var ModalPortal = module.exports = React.createClass({
  ...
  handleKeyDown: function(event) {
    ...
    if (event.keyCode == 27 /*esc*/) this.requestClose(constants.CLOSE_REQUEST_ESC);
  },

  handleOverlayClick: function() {
    if (this.ownerHandlesClose())
      this.requestClose(constants.CLOSE_REQUEST_OVERLAY);
    else
      this.focusContent();
  },

  requestClose: function(source) {
    if (this.ownerHandlesClose())
      this.props.onRequestClose({source: source});
  },
